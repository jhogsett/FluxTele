// Field Day Configuration - Must be defined before including sim_station2.h
...
bool SimStation2::begin(unsigned long time){
    ...
    wavegen->set_frequency(SPACE_FREQUENCY2, false);
    
    // Set _enabled and force frequency update with existing _vfo_freq
