...
void AsyncDTMF2::configure_timing(TelcoType type)
{
    switch (type) {
        case TELCO_RINGBACK:
...
void AsyncDTMF2::start_next_phase(unsigned long time)
{
...
unsigned long AsyncDTMF2::get_random_silence_duration()
{
