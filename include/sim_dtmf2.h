#ifndef __SIM_DTMF2_H__
#define __SIM_DTMF2_H__

#include "async_dtmf2.h"
...
class SimDTMF2 : public SimDualTone
{
public:
    SimDTMF2(WaveGenPool *wave_gen_pool, SignalMeter *signal_meter, float fixed_freq, TelcoType type);
...
private:
    AsyncDTMF2 _telco;              // AsyncDTMF2 for ring cadence timing
